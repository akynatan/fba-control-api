...
var _AuthenticationUserService = _interopRequireDefault(require("./AuthenticationUserService"));
...
describe('AuthenticationUser', () => {
  beforeEach(() => {
    ...
    authenticationUser = new _AuthenticationUserService.default(fakeUsersRepository, fakeHashProvider);
  });
